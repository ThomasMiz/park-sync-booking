...
import edu.itba.serverdps.exceptions.CheckAvailabilityInvalidArgumentException;
import edu.itba.serverdps.exceptions.InvalidSlotException;
...
public class BookingServiceImpl extends BookingServiceGrpc.BookingServiceImplBase {
    ...
    public void getAttractions(Empty request, StreamObserver<GetAttractionsResponse> responseObserver) {
        ...
        for (Attraction attraction : attractions) {
            responseBuilder.addAttraction(edu.itba.serverdps.grpc.Attraction.newBuilder()
